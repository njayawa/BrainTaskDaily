...
Begin VB.Form frmCategory 
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select Serial, Name, Enabled from Category"
      Caption         =   " "
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
...
Private Sub grdDataGrid_DblClick()
    fTip.datPrimaryRS.RecordSource = "SELECT * FROM TIP WHERE Category_Serial = " & datPrimaryRS.Recordset!Serial
    fTip.datPrimaryRS.Tag = CInt(datPrimaryRS.Recordset!Serial)
    fTip.datPrimaryRS.Refresh
    fTip.Show
    fTip.ZOrder
End Sub
